...
// スレッドセーフ。
func newFileCodeContainer(minIdLen int, procId string, savDur, ticExpDur time.Duration, path, expiPath string, caStaleDur, caExpiDur time.Duration) codeContainer {
